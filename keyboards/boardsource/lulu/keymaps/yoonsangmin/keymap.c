...
#define GAME1      TO(_GAME1)
#define GAME2      TO(_GAME2)
 ...
 */
  ...
  _______, _______, _______, _______, _______, _______,                   _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_ENT,
  _______, _______, _______, _______, _______, _______, QWERTY,  _______, _______, _______, _______, _______, _______, _______,
                             KC_GRV,  KC_LSFT, KC_LALT, KC_SPC,  _______, _______, _______, _______
  ),
/* MOUSE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |EHLEFT|EHRGHT|NK TOG|                    |      |      |      |      |      |      |
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 */
[_MOUSE] = LAYOUT(
  _______, _______, _______, EH_LEFT, EH_RGHT, NK_TOGG,                   _______, _______, _______, _______, _______, _______,
 ...
 */
[_NUMBER] = LAYOUT(
  QK_BOOT, EE_CLR,  KC_NUM,  _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
  ...
  _______, KC_ESC,  KC_P1,   KC_P2,   KC_P3,   KC_BSPC, _______, _______, _______, GAME1,   GAME2,   _______, _______, _______,
                             KC_P0,   _______, KC_PDOT, _______, _______, KC_DEL,  KC_LBRC, _______
  ),
/* NAVIGATION
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |NK TOG|EHRGHT|EHLEFT|      |      |      |
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 */
  [_NAVIGATION] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   NK_TOGG, EH_RGHT, EH_LEFT, _______, _______, _______,
