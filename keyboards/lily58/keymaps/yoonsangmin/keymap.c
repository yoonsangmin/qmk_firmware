 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LGUI,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    /*REDOMOD*/_______, KC_MUTE, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RALT,
...
[_MOUSE] = LAYOUT(
  ...
  _______, KC_QUOT, KC_DQUO, KC_LPRN, KC_RPRN, KC_TILD, _______, _______, /*REDO*/_______,    PASTE,   COPY,    CUT,     UNDO,    _______,
 ...
 */
  ...
  _______, KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_BSPC, _______, _______, /*REDO*/_______,    PASTE,   COPY,    CUT,     UNDO,    _______,
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      | Mute | Vol- | Vol+ |      |-------.    ,-------| SCRL |  F4  |  F5  |  F5  |  F11 |      |
 * |      |      |      |      |      |      |       |    |       |      |      |      |      |      |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 ...
 */
  ...
  _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,                   KC_SCRL, KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______,
